...
INPUT_DIR = '/Users/tyleryoung/Downloads/2021_CIPM_2021_01_07_17_37_49/2021_CIPM_L1_HTML'
  ...
  def extract_html(html_files)  
    html_files.each do |html_file|  
      ...
      containers.each do |container|
        ...
        xid = container.at_css('h4').content
        
        container.at_css('h4').content = 'Solution'
        container.at_css('h4').name = 'h4'
